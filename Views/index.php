    ...
    <div id="my_slider" class="carousel slide" data-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <div class="row">
            <div class="col-sm-12">
              <h1 class="banner_taital">OFERTAS <br>En tus compras del 1 al 31 de Julio obten envio gratis</h1>
            </div>
          </div>
        </div>
        <div class="carousel-item">
          <div class="row">
            <div class="col-sm-12">
              <h1 class="banner_taital">NOTICIAS <br>Nuevo metodo de pago con PAPYPAL ya disponible</h1>
            </div>
          </div>
        </div>
        <div class="carousel-item">
          <div class="row">
            <div class="col-sm-12">
              <h1 class="banner_taital">PRODUCTOS <br>Laptops recien ingresadas disponibles</h1>
            </div>
          </div>
        </div>
      </div>
